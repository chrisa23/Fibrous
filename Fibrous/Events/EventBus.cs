...
public static class EventBus<T>
{
    ...
    public static void Publish(T message) => Channel.Publish(message);
    ...
    public static IDisposable SubscribeToBatch(
        IFiber fiber,
        Func<T[], Task> receive,
        TimeSpan interval) =>
        Channel.SubscribeToBatch(fiber, receive, interval);

    public static IDisposable SubscribeToKeyedBatch<TKey>(
        IFiber fiber,
    ...
    public static IDisposable SubscribeToLast(
        IFiber fiber,
        Func<T, Task> receive,
        TimeSpan interval) =>
