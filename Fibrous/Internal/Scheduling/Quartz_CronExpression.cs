...
public class CronExpression : IDeserializationCallback, ISerializable
{
    ...
    {
        DateTimeOffset withoutMilliseconds = new(dateUtc.Year, dateUtc.Month, dateUtc.Day,
            ...
            if (dayOfMSpec && !dayOfWSpec)
            {
                ...
                if (lastdayOfMonth)
                {
                    ...
                    else
                    {
                        ...
                        DateTimeOffset nTime = new(tcal.Year, mon, day, hr, min, sec, d.Millisecond,
                            d.Offset);
    ...
    protected static DateTimeOffset CreateDateTimeWithoutMillis(DateTimeOffset time) =>
        new(time.Year, time.Month, time.Day, time.Hour, time.Minute, time.Second, time.Offset);
    ...
    protected static DateTimeOffset SetCalendarHour(DateTimeOffset date, int hour)
    {
        ...
        DateTimeOffset d = new(date.Year, date.Month, date.Day, hourToSet, date.Minute, date.Second,
