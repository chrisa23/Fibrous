namespace Fibrous.Experimental
{
    ...
    {
        private PaddedLong _value = new PaddedLong(-1);
        ...
        /// </summary>
        public virtual long Value { get { return _value.ReadFullFence(); } set { _value.WriteFullFence(value); } }
        ...
        {
            return _value.CompareExchange(nextSequence, expectedSequence);
        }
