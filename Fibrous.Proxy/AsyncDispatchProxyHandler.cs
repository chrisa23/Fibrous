...
namespace System.Reflection
{
    ...
    {
        public object InvokeHandle(object[] args) => Invoke(args);

        public Task InvokeAsyncHandle(object[] args) => InvokeAsync(args);

        public Task<T> InvokeAsyncHandleT<T>(object[] args) => InvokeAsync<T>(args);
    }
    ...
    internal static class AsyncDispatchProxyGenerator
    {
        ...
        {
            ProxyMethodResolverContext context = Resolve(args);
        ...
        public static async Task<T> InvokeAsync<T>(object[] args)
        {
            ...
            try
            {
                ...
                MethodInfo genericmethod = s_dispatchProxyInvokeAsyncTMethod.MakeGenericMethod(typeof(T));
        ...
        private class ProxyAssembly
        {
            ...
            public ProxyAssembly()
            {
                ...
                AssemblyName assemblyName = new AssemblyName("ProxyBuilder2");
        ...
        private class ProxyBuilder
        {
            ...
            internal void AddInterfaceImpl(Type iface)
            {
                ...
                Dictionary<MethodInfo, PropertyAccessorInfo> propertyMap =
                    new Dictionary<MethodInfo, PropertyAccessorInfo>(MethodInfoEqualityComparer.Instance);
                foreach (PropertyInfo pi in iface.GetRuntimeProperties())
                {
                    PropertyAccessorInfo ai = new PropertyAccessorInfo(pi.GetMethod, pi.SetMethod);
                ...
                Dictionary<MethodInfo, EventAccessorInfo> eventMap =
                    new Dictionary<MethodInfo, EventAccessorInfo>(MethodInfoEqualityComparer.Instance);
                foreach (EventInfo ei in iface.GetRuntimeEvents())
                {
                    EventAccessorInfo ai = new EventAccessorInfo(ei.AddMethod, ei.RemoveMethod, ei.RaiseMethod);
            ...
            private MethodBuilder AddMethodImpl(MethodInfo mi)
            {
                ...
                {
                    Type[] returnTypes = mi.ReturnType.GetGenericArguments();
